...
function indexMod()
{
	...
	if (!is_file(GLPI_ROOT.'/css_compiled/css_styles.min.css.bak')) {
		copy(GLPI_ROOT . '/css_compiled/css_styles.min.css', GLPI_ROOT . '/css_compiled/css_styles.min.css.bak');
	}
	copy('./src/css/css_styles.min.css', GLPI_ROOT . '/css_compiled/css_styles.min.css');
}
...
function indexDef()
{
	...
	if (is_file(GLPI_ROOT.'/css_compiled/css_styles.min.css.bak')) {
		copy(GLPI_ROOT.'/css_compiled/css_styles.min.css.bak',GLPI_ROOT.'/css_compiled/css_styles.min.css');
	}
}
